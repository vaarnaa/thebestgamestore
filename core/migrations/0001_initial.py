# Generated by Django 2.0 on 2018-02-22 16:21
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('time', models.DateTimeField(default=datetime.datetime(2018, 2, 22, 18, 21, 21, 235919))),
        ...
        migrations.AddField(
            model_name='order',
            name='payment',
            field=models.OneToOneField(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='order', to='core.Payment'),
        ),
        migrations.AddField(
            model_name='user',
            name='groups',
